...
#include "2048_icon.c"
	...
	int shift = (gimp_icon.bytes_per_pixel == 3) ? 8 : 0;
	...
	gmask = 0x0000ff00;
	bmask = 0x00ff0000;
	amask = (gimp_icon.bytes_per_pixel == 3) ? 0 : 0xff000000;
#endif

	SDL_Surface* icon = SDL_CreateRGBSurfaceFrom((void*)gimp_icon.pixel_data, gimp_icon.width,
			gimp_icon.height, gimp_icon.bytes_per_pixel*8, gimp_icon.bytes_per_pixel*gimp_icon.width,
